...
export function StoryRouteTransition({ active, phase, story }) {
  return (
    ...
    >
      ...
      <div
        className={`absolute h-[120vmax] w-[120vmax] rounded-full border border-[#f7d995]/26 bg-[radial-gradient(circle,rgba(255,232,182,0.22)_0%,rgba(232,196,125,0.08)_24%,rgba(5,7,19,0.94)_58%,rgba(5,7,19,0)_72%)] shadow-[inset_0_0_90px_rgba(247,217,149,0.18),0_0_90px_rgba(232,196,125,0.18)] transition-all duration-[900ms] ease-in-out
          ${active ? "scale-100 opacity-100" : "scale-50 opacity-0"}
          ${phase === "exit" ? "rotate-12" : "-rotate-12"}`}
      />
      <div
        className={`relative grid gap-3 text-center transition-all duration-500 ease-in-out
